      ...
      <div className="relative pt-24 pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              variants={itemVariants}
              className="text-5xl md:text-7xl font-extrabold text-primary mb-6 tracking-tight leading-[1.1]"
            >
              Shipping Made <br />
            ...
            >
              Experience the future of delivery with AI-powered routing,
              real-time tracking, and lightning-fast dispatch. We move your
              world.
            </motion.p>
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-wrap justify-center lg:justify-start gap-8 md:gap-12 text-gray-500"
            >
          ...
          {[
            {
              ...
              desc: "Our AI optimizes routes in real-time to ensure the fastest delivery times possible.",
            },
            {
              icon: "📍",
              title: "Live Tracking",
              desc: "End-to-end visibility. Know exactly where your package is at every second.",
            },
            {
              icon: "🛡️",
              title: "Secure Handling",
              desc: "From pickup to drop-off, your items are handled with maximum security and care.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24">
        <div className="bg-primary rounded-[40px] p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto mb-10 text-lg relative z-10">
            Join thousands of businesses and individuals who trust NaviLogix for
            their daily logistics needs.
          </p>
          <button
            onClick={() => navigate("/register")}
            className="bg-white text-primary px-10 py-4 rounded-full font-bold text-lg hover:bg-secondary hover:text-white transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 relative z-10"
          >
            Get Started Now
          </button>
        </div>
